...
import it.neo4j.integration.couchbase.event.dispatcher.couchbase.CouchbaseEventDispatcher;
import it.neo4j.integration.couchbase.event.handler.couchbase.Neo4jWriter;
...
public class CouchbaseEventHandlerTest {
	...
	public void shouldTraceChangesOnCouchbase() {
		...
		CouchbaseEventDispatcher couchbaseEventHandler = new CouchbaseEventDispatcher(cluster.core(), "default", Arrays.asList("127.0.0.1"), "", new Neo4jWriter());
		...
		JsonObject user = JsonObject.empty()
			    ...
			    .put("lastname", "Speranzoni")
			    .put("job", "CEO @ LARUS Business Automation")
			    .put("age", 41);
